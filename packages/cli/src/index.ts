...
/**
 * @minions-territories/cli — CLI for Minions Territories
 *
...
import { customTypes } from '@minions-territories/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Territories'));
        console.log(chalk.dim('Country, state, region, city definitions, focus queue, and saturation tracking'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-territories/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-territories/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-territories')}`);
