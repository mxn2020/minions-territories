# Manual Setup Steps for Minions Territories
...
Go to **GitHub → mxn2020/minions-territories → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-territories` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-territories-web`
- **GitHub repo**: `mxn2020/minions-territories`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `territories.minions.wtf`

### Documentation
- **Netlify site name**: `minions-territories-docs`
- **GitHub repo**: `mxn2020/minions-territories`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `territories.minions.help`

### Blog
- **Netlify site name**: `minions-territories-blog`
- **GitHub repo**: `mxn2020/minions-territories`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `territories.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `territories.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `territories.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `territories.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-territories/sdk`](https://www.npmjs.com/package/@minions-territories/sdk)
- CLI: [`@minions-territories/cli`](https://www.npmjs.com/package/@minions-territories/cli)
...
Your package: [`minions-territories`](https://pypi.org/project/minions-territories/)
...
| Item | Value |
|------|-------|
| Project | `minions-territories` |
| SDK (npm) | `@minions-territories/sdk` |
| CLI (npm) | `@minions-territories/cli` |
| Python (PyPI) | `minions-territories` |
| GitHub | `github.com/mxn2020/minions-territories` |
| Docs domain | `territories.minions.help` |
| Blog domain | `territories.minions.blog` |
| App domain | `territories.minions.wtf` |
